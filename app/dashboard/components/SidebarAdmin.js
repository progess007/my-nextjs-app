...
const SidebarAdmin = React.memo(({ user, setCurrentPage, currentPage, isSidebarOpen, toggleSidebar }) => {
  ...
  const handleLogout = () => {
    ...
    const menuItems = [
        ...
        { label: 'นำเข้ากฎความสัมพันธ์', icon: FaChalkboardTeacher, page: 'association' },
        { label: 'นำเข้าหนังสือ', icon: FaBook, page: 'newbook' },
    ];
